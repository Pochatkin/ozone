...
public interface S3SecretManager {
   ...
   */
  void store(String kerberosId, S3SecretValue secretValue) throws IOException;
   ...
   */
  void revoke(String kerberosId) throws IOException;
  ...
  default boolean hasS3Secret(String kerberosId) throws IOException {
    return getS3Secret(kerberosId) != null;
  }
